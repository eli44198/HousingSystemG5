        ...
        def modify(house_name):
            ...
            try:
                ...
                if attributes == "Name":
                    ...
                    print(f"\nPrevious name was >>>>>> details[name]")
                ...
                elif attributes == "house_Id":

                    print(f"\nPrevious name was >>>>>> details[House_Id]")

                    new_name = input("\nEnter a new name >>>>>>")

                    database.write("\n house[House_Id] = new_id")
